...
class TexyConvert
{
	 ...
	 * @return array
	 */
	private function getDTD(int $mode): array
	{
		...
		if (!$strict) {
			$i += [
				...
				'font' => 1,
				'applet' => 1,
				'basefont' => 1, // transitional
				'embed' => 1,
				'wbr' => 1,
				'nobr' => 1,
				'canvas' => 1 // proprietary
			];
		}
